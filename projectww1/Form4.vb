...
Public Class cruiser
    ...
    Private Sub fetch_Click(sender As Object, e As EventArgs) Handles fetch.Click
        FetchBikeDetails(1) ' Fetch details for Bike 1
    End Sub

    ' Button to fetch details for BikeID 2
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        FetchBikeDetails(2) ' Fetch details for Bike 2
    End Sub

    ' Button to fetch details for BikeID 3
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        FetchBikeDetails(3) ' Fetch details for Bike 3
    End Sub

    ' Button to fetch details for BikeID 4
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        FetchBikeDetails(4) ' Fetch details for Bike 4
    End Sub
